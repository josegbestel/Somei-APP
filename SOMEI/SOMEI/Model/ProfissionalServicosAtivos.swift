...
class ProfissionalServicosAtivos {
    ...
    static func byDict(dict :[String : Any]) -> Orcamento {
        ...
        let orcamento = Orcamento(profissao: profissao, descricao: descricao, photos: nil, linkPhotos: nil, endereco: endereco, data: data, horario: nil, status: status, valorMinimo: valorMinimo, id: nil, serviceId: nil, agendaId: nil, agendaArray: nil, solicitante: nil, profissional: nil)
