...
class OrcamentoManager {
    ...
    var createOrcamento = Orcamento(profissao: nil, descricao: nil, photos: [], linkPhotos: [], endereco: nil, data: nil, horario: nil, status: nil, valorMinimo: nil, id: nil, agendaId: nil, agendaArray: nil, solicitante: nil)
